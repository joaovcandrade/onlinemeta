      ...
      <div className="wrapper-group">
        ...
        {showControlGuide && (
          <Wrapper>
            ...
            <ul>
              <li>
                <strong>W, A, S, D ou as teclas de seta</strong> para se mover
              </li>
              <li>
                <strong>E</strong> para sentar (quando estiver de frente para uma cadeira)
              </li>
              <li>
                <strong>R</strong> para usar o computador e compartilhar a tela (quando estiver de frente para um computador)
              </li>
              <li>
                <strong>Enter</strong> para abrir o chat
              </li>
              <li>
                <strong>ESC</strong> para fechar o chat
              </li>
            </ul>
            {/* <p className="tip">
              <LightbulbIcon />
              A conexão de vídeo será iniciada se você estiver próximo a outra pessoa
            </p> */}
          </Wrapper>
        )}
      </div>
